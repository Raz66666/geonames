...
<div id="main_div">
	...
	<div id="content" class="content">
		...
		<table cellspacing="0" id="tab_files" style="display:none;">
			...
			<tr><td width="8"><form id="save_file" method="GET" style="visibility:hidden;display:inline;" target=save></form><input type="button" value="{$SXD->LNG['btn_delete']}" onclick="sxd.runFiles('delete')"></td><td width="290" align="right">
